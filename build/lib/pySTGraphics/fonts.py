...
ProFontWindows = os.path.join(package_directory, 'fonts_resource', "ProFontWindows.ttf")
DigitalItalicFont = os.path.join(package_directory, 'fonts_resource', "DS-Digital-ItalicST.ttf")
Vera = os.path.join(package_directory, 'fonts_resource', "Vera.ttf")
VeraB = os.path.join(package_directory, 'fonts_resource', "VeraMoBd.ttf")
...
def initFonts():
	...
	print("profontwindows path: ")
	print(ProFontWindows)
